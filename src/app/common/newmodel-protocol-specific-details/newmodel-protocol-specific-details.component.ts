...
@Component({
  selector: 'app-newmodel-protocol-specific-details',
  templateUrl: './newmodel-protocol-specific-details.component.html',
  styleUrls: ['./newmodel-protocol-specific-details.component.css']
})
export class NewmodelProtocolSpecificDetailsComponent implements OnInit {
