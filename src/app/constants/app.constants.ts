...
export class CONSTANTS {
  ...
  public static SIDE_MENU_LIST = [
    ...
    },
    {
      ...
      showAccordion: [
        ...
        { name: 'Add Option', type: 'checkbox', value: true },
      ],
    ...
    },
    {
      ...
      showAccordion: [
        ...
        { name: 'Pre-Generated Reports', type: 'checkbox', value: true },
      ],
  ...
  public static ASSET_CONTROL_PANEL_SIDE_MENU_LIST = [
    ...
    },
    {
      ...
      showAccordion: [
        { name: 'Test Connection', key: 'test_connection' },
        { name: 'Fota', key: 'fota' },
        { name: 'Manage Applications', key: 'manage_application' },
        { name: 'Manage Assets', key: 'manage_assets' },
        { name: 'Sync Slaves', key: 'sync_slaves' },
        { name: 'Sync Properties', key: 'sync_properties' },
        { name: 'Sync Rules', key: 'sync_rules' },
        { name: 'Settings', key: 'settings' },

      ],
      accordion_value: { test_connection: true, fota: true, manage_application: true, manage_assets: true, sync_slaves: true, sync_properties: true, sync_rules: true, settings: true },
    },
    {
      page: 'uptime',
      system_name: 'Uptime',
  ...
  public static LEGACY_ASSET_CONTROL_PANEL_SIDE_MENU_LIST = [
    ...
    // },
    {
      ...
      accordion_value: { manage_assets: true, sync_slaves: true, sync_properties: true, sync_rules: true, settings: true },
      // showAccordion: [],
      // accordion_value: {},
    },
    {
  ...
  public static GATEWAY_DIAGNOSIS_PANEL_SIDE_MENU_LIST = [
    ...
    },
    {
      ...
      accordion_value: { test_connection: true, fota: true, manage_application: true },
      // showAccordion: [],
      // accordion_value: {},
    },
    {
  ...
  public static MODEL_CONTROL_PANEL_SIDE_MENU_LIST = [
    ...
    {
      page: 'edge_derived_measured',
      system_name: 'NewEdge Derived',
      url: '#newasset_model',
    ...
    {
      page: 'controllable_measured',
      system_name: 'New Controllable Properties',
      url: '#newasset_model',
    ...
    {
      page: 'configurable_measured',
      system_name: 'New Configurable Properties',
      url: '#newasset_model',
  ...
  public static MISCELLANEOUS_MENU_SIDE_MENU_LIST = [
    {
      page: 'manage',
      system_name: 'Manage',
      url: null,
    ...
    {
      page: 'sMS_recipients',
      system_name: 'SMS Recipients',
      url: '#user_sms_recipients',
      display_name: 'SMS Recipients',
      icon: 'fa fa-fw fa-users',
      visible: true,
      isTitle: false,
      privileges_required: [],
    ...
    {
      page: 'whatsapp_recipients',
      system_name: 'Whatsapp Recipients',
      url: '#user_whatsapp_recipients',
      display_name: 'SMS Recipients',
      icon: 'fa fa-fw fa-users',
      visible: true,
      isTitle: false,
    ...
    {
      page: 'push_notification_recipients',
      system_name: 'Push Notification Recipients',
      url: '#user_push_notification_recipients',
      display_name: 'SMS Recipients',
      icon: 'fa fa-fw fa-users',
      visible: true,
      isTitle: false,
    ...
    {
      page: 'escalationTime',
      system_name: 'Escalation Time (By default Infinite)',
      url: '#asset_rules',
