export class AppUrls {
  ...
  public static BULK_DELETE_ASSETS_WIDGET = 'asset_models/{0}/widget';
  ...
  public static GET_ASSET_SLAVE_DETAILS = 'asset_slaves';
  public static GET_ASSET_CELL_DETAILS = 'hierarchy_cells_by_hierarchyorid';
