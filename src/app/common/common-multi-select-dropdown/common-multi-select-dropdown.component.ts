...
import { IDropdownSettings, ListItem } from './multi-select-dropdown.model';

export const DROPDOWN_CONTROL_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  // tslint:disable-next-line: no-use-before-declare
  useExisting: forwardRef(() => CommonMultiSelectDropdownComponent),
  multi: true,
};
const noop = () => {};
@Component({
  selector: 'app-common-multi-select-dropdown',
  templateUrl: './common-multi-select-dropdown.component.html',
  styleUrls: ['./common-multi-select-dropdown.component.css']
})
export class CommonMultiSelectDropdownComponent {
