...
declare var $: any;
@Component({
  selector: 'app-device-type-slave-info',
  templateUrl: './device-type-slave-info.component.html',
  styleUrls: ['./device-type-slave-info.component.css']
})
export class DeviceTypeSlaveInfoComponent implements OnInit, OnDestroy {
  ...
  getSlaveCategories() {
    ...
    const filterObj = {};
    this.subscriptions.push(this.deviceTypeService.getModelSlaveCategories(this.contextApp.app, this.deviceType.name, filterObj)
    .subscribe((response: any) => {
      if (response?.data) {
  ...
  getSlavePositions() {
    this.slavePositions = [];
    const filterObj = {};
    this.subscriptions.push(this.deviceTypeService.getModelSlavePositions(this.contextApp.app, this.deviceType.name, filterObj)
    .subscribe((response: any) => {
      if (response?.data) {
  ...
  saveSlaveObj() {
    ...
    this.subscriptions.push(this.deviceTypeService.createModelSlaveDetail(this.contextApp.app, this.deviceType.name, this.slaveObj)
    .subscribe((response: any) => {
  ...
  updateSlaveObj() {
    ...
    this.subscriptions.push(this.deviceTypeService.updateModelSlaveDetail(this.contextApp.app, this.deviceType.name,
  ...
  deleteSlave() {
    ...
    this.subscriptions.push(this.deviceTypeService.deleteModelSlaveDetail(this.contextApp.app, this.deviceType.name, this.deleteSlaveObj.id)
    .subscribe((response: any) => {
  ...
  saveSlavePositionObj() {
    ...
    this.isCreateSlaveAPILoading = true;
    this.slaveObj.created_by = this.userData.email + ' (' + this.userData.name + ')';
    this.subscriptions.push(this.deviceTypeService.createModelSlavePosition(this.contextApp.app, this.deviceType.name, this.slaveObj)
    .subscribe((response: any) => {
  ...
  updateSlavePositionObj() {
    ...
    this.isCreateSlaveAPILoading = true;
    this.slaveObj.updated_by = this.userData.email + ' (' + this.userData.name + ')';
    this.subscriptions.push(this.deviceTypeService.updateModelSlavePosition(this.contextApp.app, this.deviceType.name,
      this.slaveObj.id, this.slaveObj)
    .subscribe((response: any) => {
  ...
  deleteSlavePosition() {
    this.isDeleteSlaveAPILoading = true;
    this.subscriptions.push(this.deviceTypeService.deleteModelSlavePosition(this.contextApp.app, this.deviceType.name, this.deleteSlaveObj.id)
    .subscribe((response: any) => {
  ...
  saveSlaveCategoryObj() {
    ...
    this.isCreateSlaveAPILoading = true;
    this.slaveObj.created_by = this.userData.email + ' (' + this.userData.name + ')';
    this.subscriptions.push(this.deviceTypeService.createModelSlaveCategory(this.contextApp.app, this.deviceType.name, this.slaveObj)
    .subscribe((response: any) => {
  ...
  updateSlaveCategoryObj() {
    ...
    this.isCreateSlaveAPILoading = true;
    this.slaveObj.updated_by = this.userData.email + ' (' + this.userData.name + ')';
    this.subscriptions.push(this.deviceTypeService.updateModelSlaveCategory(this.contextApp.app, this.deviceType.name,
      this.slaveObj.id, this.slaveObj)
    .subscribe((response: any) => {
  ...
  deleteSlaveCategory() {
    this.isDeleteSlaveAPILoading = true;
    this.subscriptions.push(this.deviceTypeService.deleteModelSlaveCategory(this.contextApp.app, this.deviceType.name, this.deleteSlaveObj.id)
    .subscribe((response: any) => {
