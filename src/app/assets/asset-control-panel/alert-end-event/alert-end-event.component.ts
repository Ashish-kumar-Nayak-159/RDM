...
export class AlertEndEventComponent implements OnInit, OnDestroy {
  ...
  searchAlerts(filterObj, updateFilterObj = true) {
    ...
    this.apiSubscriptions.push(this.assetService.getAssetAlertEndEvents(obj).subscribe(
      (response: any) => {
  ...
  getAlertMessageData(alert) {
    return new Promise((resolve) => {
      ...
      this.apiSubscriptions.push(this.assetService.getAssetMessageById(obj, 'alertendevent').subscribe(
        (response: any) => {
